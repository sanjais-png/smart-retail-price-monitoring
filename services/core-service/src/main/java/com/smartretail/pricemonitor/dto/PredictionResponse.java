...
public class PredictionResponse {
    ...
    @Schema(description = "95% Prediction Interval lower bound in INR", example = "52.80")
    private BigDecimal lowerBound;

    @Schema(description = "95% Prediction Interval upper bound in INR", example = "64.70")
    private BigDecimal upperBound;

    @Schema(description = "Prediction interval type", example = "VALIDATED_95_PREDICTION_INTERVAL")
